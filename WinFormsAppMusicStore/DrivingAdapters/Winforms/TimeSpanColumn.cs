...
namespace WinFormsAppMusicStoreAdmin.DrivingAdapters.Winforms
{
    ...
    {
        public TimeSpanColumn() : base(new TimeSpanCell())
        {
        }
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                ...
                if (value != null &&
                    !value.GetType().IsAssignableFrom(typeof(TimeSpanCell)))
                {
    ...
    public class TimeSpanCell : DataGridViewTextBoxCell
    {
            ...
            initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            TimeSpanEditingControl ctl =
                DataGridView.EditingControl as TimeSpanEditingControl;
    ...
    class TimeSpanEditingControl : DateTimePicker, IDataGridViewEditingControl
    {
